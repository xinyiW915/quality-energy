...
if __name__ == '__main__':
    ...
    ugcdata_down_path = '/home/um20242/quality-energy/videocodec_downsample_4k/downsample_ugc/'
    encode_path = '/home/um20242/quality-energy/videocodec_downsample_4k/encode/'
    decode_path = '/home/um20242/quality-energy/videocodec_downsample_4k/decode/'
    upscale_path = '/home/um20242/quality-energy/videocodec_downsample_4k/upscale/'
    ffmpeg_path = '/home/um20242/quality-energy/videocodec_downsample_4k/ffmpeg/'
    ...
    for i in range(len(ugcdata)):
        ...
        for index, (downsample_video, qp, downsample_width, downsample_height) in enumerate(result_list):
            ...
            # --------------------Start Encode------------------------
            cmd_encode, encoded_video, encoded_video_log = encoding_video(codec, downsample_duplicate, qp, framerate, downsample_width,
            ...
            start_time_encode, end_time_encode, encode_power_log = measure_command_runtime_rapl(cmd_encode, codec, downsample_duplicate, 'encoded', qp)
            ...
            start_time_decode, end_time_decode, decode_power_log = measure_command_runtime_rapl(cmd_decode, codec, downsample_duplicate, 'decoded', qp)
        ...
        print(df_metrics)
        energy_name = f'../metrics/rapl_energy/{codec}/YOUTUBE_UGC_2160P_downsample_{codec}_metrics_timestamp_duplicate_energy_{video}.csv'
        ...
        df_encoding_power_name = f'../metrics/rapl_energy_log/{codec}/YOUTUBE_UGC_2160P_downsample_{codec}_duplicate_encoding_power_log_{video}.csv'
        ...
        df_decoding_power_name = f'../metrics/rapl_energy_log/{codec}/YOUTUBE_UGC_2160P_downsample_{codec}_duplicate_decoding_power_log_{video}.csv'
