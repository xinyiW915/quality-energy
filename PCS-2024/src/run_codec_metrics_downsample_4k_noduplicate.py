...
if __name__ == '__main__':
    ...
    for i in range(len(ugcdata)):
        ...
        print(df_metrics)
        metrics_name = f'../videocodec_downsample_4k/YOUTUBE_UGC_2160P_downsample_{codec}_metrics.csv'
        ...
        for downsample_video, qp, downsample_width, downsample_height in result_list:
            ...
            os.remove(encoded_video)
            os.remove(decode_video)
            os.remove('../metrics/10102023/energy_log/power_log.csv')
        os.remove(downsample_video_1080)
        os.remove(downsample_video_720)
        os.remove(original_video)
    ...
    print(df_metrics)
    energy_name = f'../metrics/energy/YOUTUBE_UGC_2160P_downsample_{codec}_metrics_timestamp_noduplicate_distribution_energy_{category}.csv'
    ...
    df_encoding_power_name = f'../metrics/energy_log/YOUTUBE_UGC_2160P_downsample_{codec}_noduplicate_encoding_power_log.csv'
    ...
    df_decoding_power_name = f'../metrics/energy_log/YOUTUBE_UGC_2160P_downsample_{codec}_noduplicate_decoding_power_log.csv'
